...
<head>
    ...
    <title>Resume - Hosen Rabby</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">Hosen Rabby</span>
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2"
                    src="{{ url('public/assets/img/profile.jpg') }}" alt="..." /></span>
        </a>
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                <h1 class="mb-0">
                    Hosen
                    <span class="text-primary">Rabby</span>
                </h1>
                <div class="subheading mb-5">
                    35/1 West Vhasantak · Dhaka,Cantonment CO 1206 · (+880) 1864-259966 ·
                    <a href="#">tahmid.tuhin.3@gmail.com</a>
                </div>
                ...
                <div class="social-icons">
                    <a class="social-icon" href="https://www.linkedin.com/in/md-hosen-rabby-b43444182/"
                        target="_blank"><i class="fab fa-linkedin-in"></i></a>
                    <a class="social-icon" href="https://github.com/hosenrabby" target="_blank"><i
                            class="fab fa-github"></i></a>
                    <a class="social-icon" href="https://twitter.com/TahmidTuhin3" target="_blank"><i
                            class="fab fa-twitter"></i></a>
                    <a class="social-icon" href="https://www.facebook.com/tahmid.tuhin.3/" target="_blank"><i
        ...
        <section class="resume-section" id="experience">
            <div class="resume-section-content">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    ...
                    <div class="flex-shrink-0"><span class="text-primary">December 2021 - March 2013</span></div>
                </div>
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
                    ...
                    <div class="flex-shrink-0"><span class="text-primary">July 2020 - December 2011</span></div>
                </div>
                <div class="d-flex flex-column flex-md-row justify-content-between">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">Web Design Intern</h3>
                        <div class="subheading mb-3">Codurs trust bangladesh</div>
                    ...
                    <div class="flex-shrink-0"><span class="text-primary">September 2018 - June 2019</span></div>
                </div>
            </div>
        </section>
        <hr class="m-0" />
